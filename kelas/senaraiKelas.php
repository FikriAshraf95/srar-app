                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <div class="text-center">
                                                                        <a href="updateKelas.php?id=<?=$classID?>" class="btn btn-warning mx-2">
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    if (isset($_POST['id'])) {
        ...
        $deleteClass = $DB->delete($_POST);

        if($deleteClass) {
            echo("<script>sAlertRedirect('Berjaya','Kelas Dipadam','success', 'senaraiKelas.php');</script>");
        } else {
            echo("<script>sAlert('Gagal','Kelas Gagal Dipadam','error');</script>");
        }
    }
}
?>