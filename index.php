...
<html>
   <head>
      ...
      <title>AdminLTE 3 | Laman Utama</title>
               ...
               <div class="container-fluid">
                  ...
                  <div class="row">
                     ...
                     <div class="col-lg-6">
                        <div class="card">
                           ...
                           <div class="card-body">
                              ...
                              <p><button type="button" class="btn btn-block btn-success" style="width:150px;">Cari</button></p>
                           </div>
                        </div>
                     </div>
                     <!-- /.col-md-6 -->
                     <div class="col-lg-6">
                        <div class="card">
                           <div class="card-header">
                                <span class="h5 mr-2">Carian Bayaran</span><span class="text-small"><small>Mengikut Hari</small></span>
                           </div>
                           <div class="card-body">
