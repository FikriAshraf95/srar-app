...
<body class="hold-transition sidebar-mini">
                            ...
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <div class="float-right">
                                        <a href="tambahPelajar.php" class="btn btn-success mx-2">
                                            <i class="fas fa-plus"></i>
                                            <span class="mx-2">Tambah Pelajar</span>
                                        </a>
                                    </div>
                                </div>
                                <div class="card-body">
                                            ...
                                            <div class="" id="example_wrapper">
                                                <form method="POST">
                                                    <table id="tblStudent" class="table table-bordered">
                                                        ...
                                                        ?>
                                                            <tr>
                                                                <td class="text-bold"><?=$classYear?></td>
                                                                <td><?=$className?></td>
                                                                <td><?=$classTotal?></td>
                                                                <td><?=$classPIC?></td>
                                                                <td>
                                                                    <div class="text-center">
                                                                        <a href="senaraiPelajar.php?id=<?=$classID?>" class="btn btn-primary">
                                                                            <i class="fas fa-search"></i>
                                                                            <span class="mx-2">Pelajar</span>
                                                                        </a>
                                                                    </div>
                                                                </td>
                                                            </tr>
    ...
    function filterYear(data) {
        var table = $('#tblStudent').DataTable();
        table.column(0).search(data).draw();
    }
